...
; {WIN}+w / WhatsApp
#w::{
    Run "G:\Můj disk\ZÁSTUPCE\WhatsApp.lnk",, "Max"
}
;
;
;––––––––––––––––––––––––––––––––––––––––––––––––––––––––––––––––––––––––––––––
...
; {ALT}+3 / Keep
!Numpad3::{
    Run "C:\Users\" . A_UserName . "\AppData\Local\Google\Chrome\Application\chrome.exe --app=https://keep.google.com", , "Max"
    sleep "1000"
    Return
}
; {ALT}+4 / Calendar
...
; {ALT}+7 / Translate
!Numpad7::{
    Run "C:\Users\" . A_UserName . "\AppData\Local\Google\Chrome\Application\chrome.exe --app=https://translate.google.cz/?hl=cs&sl=cs&tl=en&op=translate",, "Max"
    sleep "1000"
    Return
}
; {ALT}+8 / Gemini
...
!Numpad9::{
    Run "G:\Můj disk\ZÁSTUPCE\vsc_provoz.code-workspace",, "Max"
    sleep "1000"
    Return
}
...
^!Numpad2::{
    Run "G:\Můj disk\ZÁSTUPCE\vsc_usesthis.code-workspace",, "Max"
}
;
;
;––––––––––––––––––––––––––––––––––––––––––––––––––––––––––––––––––––––––––––––
